...
public class MyHomeActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        spec.setIndicator("", resource.getDrawable(R.drawable.tab_planet));
        tabHost.addTab(spec);
        spec = tabHost.newTabSpec("tag2");
        spec.setContent(R.id.tab2);
        spec.setIndicator("", resource.getDrawable(R.drawable.tab_calendar));
        tabHost.addTab(spec);
        spec = tabHost.newTabSpec("tag3");
        spec.setContent(R.id.tab3);
        spec.setIndicator("", resource.getDrawable(R.drawable.tab_graph));
        tabHost.addTab(spec);
