...
public class CustomLineChart extends View {
    ...
    private void drawChartPoints(Canvas canvas) {
        ...
        paintChartPoint.setStyle(Paint.Style.FILL);

        paintChartPointCircle.setColor(colorChartPointCircle);
        paintChartPointCircle.setStyle(Paint.Style.STROKE);
        ...
        paintChartText.setStyle(Paint.Style.FILL);
    ...
    private void drawBaseLine(Canvas canvas) {
        ...
        paintChartBaseLine.setStyle(Paint.Style.STROKE);
    ...
    private void drawChart(Canvas canvas) {
        ...
        paintChart.setStyle(Paint.Style.FILL); // set to STOKE
        pathChart.reset();
        ...
        paintChartLine.setStyle(Paint.Style.STROKE); // set to STOKE
